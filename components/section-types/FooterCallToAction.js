...
export default function FooterCallToAction({
  ...
  return (
    <section className="relative bg-primary-900">
      ...
      <div className="relative -top-px isolate">
        <svg
          className="relative z-1 w-full scale-y-flipped transform fill-current text-white"
          xmlns="http://www.w3.org/2000/svg"
          viewBox="0 0 1000 50"
        >
      ...
      <div className="container relative z-1 max-w-screen-2xl py-12 md:py-16 lg:py-20 xl:py-24 2xl:py-28">
        <div className="grid items-start gap-8 lg:grid-cols-12">
          <div className="lg:col-span-6 lg:mt-5">
            {title && (
              <h1 className="font-heading text-4xl font-semibold text-white md:text-5xl xl:text-6xl">
                {title}
              </h1>
            )}
      ...
      <div className="relative isolate">
        ...
        <svg
          className="relative z-1 w-full fill-current text-gray-800"
          xmlns="http://www.w3.org/2000/svg"
          viewBox="0 0 1000 50"
        >
          <path d="M 0 0 Q 500 50 1000 0 L 1000 50 L 0 50" />
