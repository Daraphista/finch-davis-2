  ...
  return (
    <section className="relative bg-gray-900">
      <div className="container relative z-1 max-w-screen-xl py-8 text-left">
        <div className="rounded-sm border-2 border-primary-500 px-6 py-6 md:px-12 md:py-12 lg:px-16 lg:py-16 xl:flex xl:items-center">
          <div className="xl:-mt-2 xl:w-0 xl:flex-1">
            {title && (
              <h2 className="font-heading text-2xl text-white md:text-4xl">
                {title}
              </h2>
            )}
          </div>
          <div className="mt-8 sm:w-full sm:max-w-md xl:ml-8 xl:mt-0">
            ...
            >
              ...
              <button
                ...
                name="saveForm"
                type="submit"
                className="button mt-3 flex w-full border-transparent bg-primary-500 text-white hover:border-transparent hover:bg-primary-600 hover:text-white focus:ring-white focus:ring-offset-primary-600 sm:ml-3 sm:mt-0 sm:w-auto sm:flex-shrink-0"
              >
                Subscribe
              </button>
